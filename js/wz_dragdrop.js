...
var BODY_SCROLLHEIGHT	= 0;
var BODY_SCROLLWIDTH	= 0;
...
function my_PickFunc() {
	...
	//document.getElementById('test').innerHTML = BODY_SCROLLWIDTH;
}

/* my_DragFunc IS CALLED WHILE AN ITEM IS DRAGGED */
function my_DragFunc() {
	//my_PickFunc();
	//alert(BODY_SCROLLHEIGHT);
	
	//window.status = 'dd.elements.' + dd.obj.name + '.x  = ' + dd.obj.x + '	 dd.elements.' + dd.obj.name + '.y = ' + dd.obj.y;
	window.status = dd.getScrollY();
	if (dd.obj.x < 0) {
		dd.obj.moveTo(0, dd.obj.y);
	}
	//else if (dd.obj.x + dd.obj.w > dd.getWndW()) {
	else if (dd.obj.x + dd.obj.w > BODY_SCROLLWIDTH) {
		dd.obj.moveTo(dd.getWndW() - dd.obj.w, dd.obj.y);
		dd.obj.moveTo(BODY_SCROLLWIDTH - dd.obj.w, dd.obj.y);
	}

	if (dd.obj.y < 0) {
		dd.obj.moveTo(dd.obj.x, 0);
	}
	//else if (dd.obj.y + dd.obj.h > dd.getWndH()) {
	else if (dd.obj.y + dd.obj.h > BODY_SCROLLHEIGHT) {
		//dd.obj.moveTo(dd.obj.x, dd.getWndH() - dd.obj.h);
		dd.obj.moveTo(dd.obj.x, BODY_SCROLLHEIGHT - dd.obj.h);
	}
}
