 ...
 <tr>
    <td class="table-th" ><?=$TEXT['title']?></td >
    <td class="table-th" ><?=$TEXT['number_of_adult']?></td>
    <td class="table-th" ><?=$TEXT['number_of_childrens']?></td>
    <td class="table-th" ><?=$TEXT['action']?></td>
 ...
 <? for($i=0;$i<count($TMPL_data);$i++){?>
    <tr>
       ...
       <td><?=$TMPL_data[$i]['capacity']?></td>
       <td><?=$TMPL_data[$i]['childrens']?></td>
       <td width="25">
