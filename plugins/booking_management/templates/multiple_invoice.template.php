...
<table border="1" style="width:100%; border:solid #00000 1px;  border-collapse: collapse; " cellpadding="2" cellspacing="0">
    ...
    <tr>
        ...
        <td class="tdrow2" style="width: 150px;" align="right">
        <span class="text_black">
            <?=($TMPL_settings['rni']['value']==1)?$TMPL_room_type[$booking['room_id']]['name']." ".$TMPL_room_type[$booking['room_id']]['title']:
                $TMPL_room_type[$booking['room_id']]['title']?>
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="tdrow2"  align="right">
            <span class="text_black"><?=$booking['food_type']?></span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td bgcolor="#ccc" style="color:#000; " colspan="1" align="right"  class="pp_changed"><?=$TEXT['booking_modal']['price']?></td>
    </tr>
    ...
    <tr>
        ...
        <td align="right" class="dslr"><?=$booking['accommodation_price']?></td>
    </tr>
        <? if($TMPL_hotel_settings['is_taxable']=='yes'){?>
            <? if($TMPL_guest['tax']==1){?>
                <tr>
                    <td><?= $TEXT['invoice']['tax_price']?>  </td>
                    <td align="right" class="dslr"><?=number_format((((floatval($booking['accommodation_price']))/118)*18),2,",",".")?></td>
                </tr>
            <?}else{?>
                <tr>
                    <td><?= $TEXT['invoice']['tax_price']?> </td>
...
<table width="100%" border="1" style="width:100%; border-collapse: collapse;" cellpadding="2" cellspacing="0">
    <tr>
        <td bgcolor="#ccc" style="color:#000;"><?= $TEXT['invoice']['amount_due']?></td>
        <td bgcolor="#ccc" style="color:#000; " colspan="1" align="right"  class="pp_changed"><?=$TEXT['booking_modal']['price']?></td>
    </tr>
    <tr>
        <td align="left" class="pp_changed_exim"><?= $TEXT['invoice']['amount_due']?></td>
        <td align="right" style="width: 150px;">
            <div id="total_amount_due" style="font-weight: bold"><?=$total_price?></div>
        </td>
    </tr>
</table>
<br>
