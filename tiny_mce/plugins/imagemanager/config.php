<?php
	...
	// Authenication
	$mcImageManagerConfig['authenticator'] = "pcmsSessionAuthenticator";
	$mcImageManagerConfig['authenticator.login_page'] = "../../../auth.php"; //../../../auth.php
	$mcImageManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	#$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "";
	$mcImageManagerConfig['SessionAuthenticator.groups_key'] = "pcms_user_group";
	$mcImageManagerConfig['SessionAuthenticator.user_key'] = "pcms_user_id";
