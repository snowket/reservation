<?php
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp4,doc,docx,xls,xlsx,ppt,pptx";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp4,doc,docx,xls,xlsx,ppt,pptx";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp4,doc,docx,xls,xlsx,ppt,pptx";
	...
	// Authenication
	$mcFileManagerConfig['authenticator'] = "pcmsSessionAuthenticator";
	$mcFileManagerConfig['authenticator.login_page'] = "../../../auth.php";//
	$mcFileManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "";
	$mcFileManagerConfig['SessionAuthenticator.groups_key'] = "pcms_user_group";
	$mcFileManagerConfig['SessionAuthenticator.user_key'] = "pcms_user_id";
